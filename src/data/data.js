...
const footerComics = ['Characters', 'Comics', 'Movies', 'TV', 'Games', 'Videos', 'News'];
...
export { headerButtons, mainButtons, footerComics, footerShop, footerDC, footerSites, mainCards };
